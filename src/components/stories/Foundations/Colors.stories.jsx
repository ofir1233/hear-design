    ...
    <div style={{ maxWidth: 640, fontFamily: "'Byrd', sans-serif" }}>
      {[
        { label: 'Semantic — Light Mode', tokens: [
          ...
          { name: '--bg-card',          hex: '#FFFFFF', usage: 'Card surfaces'                    },
          { name: '--bg-elevated',      hex: '#FFFFFF', usage: 'Modals, dropdowns, popovers'      },
        ...
        { label: 'Semantic — Dark Mode', tokens: [
          ...
          { name: '--bg-elevated',      hex: '#242424', usage: 'Modals, dropdowns, popovers'      },
