      ...
      >
        <div style={{ position: 'relative', width: 272, display: 'flex', flexDirection: 'column', height: '100%', overflowY: 'auto' }}>
          ...
          <div style={{ padding: '6px 24px 4px' }}>
            ...
            >
              {/* Storybook icon — inline SVG, zero external dependency */}
              <svg
                width="16" height="16" viewBox="0 0 256 319" fill="none"
                xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                style={{ flexShrink: 0 }}
              >
                <path d="M230.814 0L236.298 68.1732L254.055 57.3195L253.714 77.7244L236.639 69.1708L237.128 135.207L220.053 126.654L219.711 62.1024L45.1646 56.2195V255.841L136.777 251.463V211.574L152.09 214.39V250.793L222.966 247.074L221.806 288.574L0 295.854L11.5866 1.38659L230.814 0Z" fill="white"/>
                <path d="M153.553 148.41C153.553 148.41 132.459 143.37 117.98 155.717C109.793 162.639 109.793 175.646 119.614 181.661C134.776 190.874 154.553 186.978 172.675 201.95C190.453 216.581 192.916 246.515 168.532 262.845C156.85 270.74 142.029 274.174 127.38 273.822C100.559 273.211 76.5153 260.044 60.3267 242.348L81.7614 219.841C91.9267 231.16 107.607 238.952 122.428 240.112C131.639 240.838 140.679 238.782 145.87 233.742C151.235 228.53 150.578 219.317 143.139 214.39C127.633 204.155 107.17 208.748 88.8787 192.933C71.6333 177.855 73.4094 152.651 92.3553 137.228C107.686 124.795 127.461 122.073 147.236 124.449L153.553 148.41Z" fill="#FF4785"/>
              </svg>
